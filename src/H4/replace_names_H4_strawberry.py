def te_annot_renamer(TE_Data):
    ...
    # Remove 'Mixture' TEs from plant genome
    TE_Data = TE_Data.drop(TE_Data[TE_Data.Order == "mixture"].index)
    # Remove 'pararetrovirus' TEs from plant genome
    TE_Data = TE_Data.drop(TE_Data[TE_Data.Order == "pararetrovirus"].index)
    # Remove 'target_site_duplication' TEs from plant genome
    TE_Data = TE_Data.drop(TE_Data[TE_Data.Order == "target_site_duplication"].index)
    # Remove 'Simple_repeat' TEs from plant genome
    TE_Data = TE_Data.drop(TE_Data[TE_Data.Order == "Simple_repeat"].index)
    # Remove 'Low_complexity' TEs from plant genome
    TE_Data = TE_Data.drop(TE_Data[TE_Data.Order == "Low_complexity"].index)
